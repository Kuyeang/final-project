                ...
                <div class="topbar-menu-area">
                    <div class="container">
                        <div class="topbar-menu left-menu">
                            <ul>
                                <li class="menu-item">
                                    <a title="Facebook: Shop Game" href="#"><span
                                            class="icon label-before fa fa-mobile"></span>Facebook: Shop Game</a>
                                </li>
                            </ul>
                        </div>
                        <div class="topbar-menu right-menu">
                            <ul>
                                ...
                                <li class="menu-item menu-item-has-children parent">
                                    <a title="My Account" href="#">My Acount({{Auth::user()->name}})<i
                                            class="fa fa-angle-down" aria-hidden="true"></i></a>
                                ...
                                <form action="#" id="form-search-top" name="form-search-top">
                                    ...
                                    <div class="wrap-list-cate">
                                        ...
                                        <ul class="list-cate">
                                            ...
                                            <li class="level-1">Keyboard</li>
                                            <li class="level-2">Headset</li>
                                            <li class="level-2">Mouse</li>
                                            <li class="level-2">Computer</li>
                    ...
                    <ul>
                        <li class="fc-info-item">
                            ...
                            <div class="wrap-left-info">
                                ...
                                <p class="fc-desc">Free in Phnom penh</p>
                            </div>
                        ...
                        <li class="fc-info-item">
                            ...
                            <div class="wrap-left-info">
                                ...
                                <p class="fc-desc">Safe your online and cash payment </p>
                            </div>
                        ...
                        <li class="fc-info-item">
                            ...
                            <div class="wrap-left-info">
                                ...
                                <p class="fc-desc">We Have Support online</p>
                            </div>
                                    ...
                                    <div class="wrap-contact-detail">
                                        <ul>
                                            <li>
                                                ...
                                                <p class="contact-txt">Address: #61, Preah Monivong Blvd., Sangkat Srah
                                                    Chork, Khan Daun Penh, Phnom
                                                    Penh, Cambodia</p>
                                            </li>
                                            <li>
                                                <i class="fa fa-phone" aria-hidden="true"></i>
                                                <p class="contact-txt">(+885) 456 789 - (+885)
                                                    666 888</p>
                                            </li>
                                            <li>
                                                <i class="fa fa-envelope" aria-hidden="true"></i>
                                                <p class="contact-txt">Gamingshop@gmail.com
                                                </p>
                                            </li>
                                        </ul>
                                    </div>
                            ...
                            <div class="wrap-footer-item">
                                ...
                                <div class="item-content">
                                    <div class="wrap-hotline-footer">
                                        ...
                                        <b class="phone-number">(+885) 456 789 - (+885) 666
                                            888</b>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="coppy-right-box">
                <div class="container">
                    <div class="coppy-right-item item-left">
                        <p class="coppy-right-text">Copyright © 2020 Surfside Media. All rights
                            reserved</p>
                    </div>
